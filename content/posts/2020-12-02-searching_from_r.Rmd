...
author: "Jimmy Briggs"
date: "2020-12-02"
categories: ["R", "Tips & Tricks", "How To"]
tags: ["R", "rstats", "development", "config"]
draft: false
image: "/images/magnifying_glass.jpg"
intro: "Utilize advanced searching techniques to quickly launch a search from R."
output:
  html_document:
    toc: yes
    toc_float: true
...
Therefore, I chose R as my framework for implementing a set of utility functions
to quickly perform advanced search queries online from a wide variety of search
engine source domains.
