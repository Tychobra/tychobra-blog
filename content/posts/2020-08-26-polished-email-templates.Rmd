---
title: "New Polished Feature - Email Templates"
author: "Andy Merlino"
date: "2020-08-26"
categories: ["R", "shiny", "polished"]
tags: ["R", "shiny", "rstats", "polished", "authentication"]
draft: false
image: "/posts/2020-08-26-polished-email-templates_files/polished_onboarding_thumb.png"
intro: "Polished is the easiest way to add authentication and user administration to your Shiny apps.  We are constantly working to make polished easier for Shiny developers to use and more useful once it is set up. We recently reworked the user invite flow to allow you to send an email invite when inviting new users to your Shiny app."
output:
  html_document
---
<br/>
...
![](/posts/2020-08-26-polished-email-templates_files/polished_onboarding.png)
...
<center>
<iframe width="560" height="315" src="https://youtube.com/embed/-ZOw6dXxa-c" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</center>
...
<center>
<iframe width="560" height="315" src="https://youtube.com/embed/MitJD58F0Ak" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</center>

<br/>

If you want to check out these features and others today, sign up for an account at [polished.tech](https://polished.tech).  We are planning a new CRAN release for polished next soon, but for now, make sure to install the dev version of polished from GitHub using:
